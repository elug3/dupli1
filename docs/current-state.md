...
- **Features:**
  ...
  - Inline schema migration + variant backfill on startup; brand/color/size/edition + subcategory/occasion/target master tables seeded on migrate
