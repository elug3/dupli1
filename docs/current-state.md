...
6. **v1.0 vs v1.1 vs v1.2** — v1.0: [v1-release-plan.md](v1-release-plan.md); v1.1 logging/sessions/access control/deploy: [v1.1-release-plan.md](v1.1-release-plan.md)
