...
- [ ] **Simple PDP recommendations** — plan in [product-views-recommendations-plan.md](product-views-recommendations-plan.md). `GET /api/v1/products/{id}/recommendations`; content similarity + `view_count` boost (depends on view counter).
