...
- [ ] **SKU master-data runtime CRUD** — code→name dictionaries with create/delete, dedicated `styles` table, FKs, catalog APIs; plan in [product-sku-master-data-plan.md](product-sku-master-data-plan.md).
