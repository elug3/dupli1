...
Environment variables:
  ...
  REDIS_URL (optional; shares the promotional-code rate-limit window across tasks),
  DUPLI1_PRODUCT_READ_TIMEOUT, DUPLI1_PRODUCT_WRITE_TIMEOUT,
  GUEST_COOKIE_NAME, GUEST_COOKIE_SECURE, GUEST_COOKIE_HTTP_ONLY, GUEST_COOKIE_MAX_AGE,
  PRODUCT_VIEWS_ENABLED
