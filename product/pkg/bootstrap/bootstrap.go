...
func Bootstrap(_ context.Context, cfg Config) (*App, error) {
	...
	handler.Mount(mux, "GET", handler.RouteCatalogSubcategories, requirePerm(permissions.ProductMasterRead, http.HandlerFunc(h.ListSubcategories)), handler.LegacyRouteCatalogSubcategories)
	handler.Mount(mux, "POST", handler.RouteCatalogSubcategories, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.CreateSubcategory)), handler.LegacyRouteCatalogSubcategories)
	handler.Mount(mux, "PATCH", handler.RouteCatalogSubcategoryByCode, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.UpdateSubcategory)), handler.LegacyRouteCatalogSubcategoryByCode)
	handler.Mount(mux, "DELETE", handler.RouteCatalogSubcategoryByCode, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.DeleteSubcategory)), handler.LegacyRouteCatalogSubcategoryByCode)
	handler.Mount(mux, "GET", handler.RouteCatalogOccasions, requirePerm(permissions.ProductMasterRead, http.HandlerFunc(h.ListOccasions)), handler.LegacyRouteCatalogOccasions)
	handler.Mount(mux, "POST", handler.RouteCatalogOccasions, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.CreateOccasion)), handler.LegacyRouteCatalogOccasions)
	handler.Mount(mux, "PATCH", handler.RouteCatalogOccasionByCode, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.UpdateOccasion)), handler.LegacyRouteCatalogOccasionByCode)
	handler.Mount(mux, "DELETE", handler.RouteCatalogOccasionByCode, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.DeleteOccasion)), handler.LegacyRouteCatalogOccasionByCode)
	handler.Mount(mux, "GET", handler.RouteCatalogTargets, requirePerm(permissions.ProductMasterRead, http.HandlerFunc(h.ListTargets)), handler.LegacyRouteCatalogTargets)
	handler.Mount(mux, "POST", handler.RouteCatalogTargets, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.CreateTarget)), handler.LegacyRouteCatalogTargets)
	handler.Mount(mux, "PATCH", handler.RouteCatalogTargetByCode, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.UpdateTarget)), handler.LegacyRouteCatalogTargetByCode)
	handler.Mount(mux, "DELETE", handler.RouteCatalogTargetByCode, requirePerm(permissions.ProductMasterWrite, http.HandlerFunc(h.DeleteTarget)), handler.LegacyRouteCatalogTargetByCode)
