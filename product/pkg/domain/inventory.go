...
// StockItem is per-sku stock state, keyed by the canonical SkuID.
// SKU is a denormalized display copy, kept in sync by the store.
...
// ReservationItem references a sku by its canonical SkuID. SKU is a
// denormalized display copy for audit/support purposes.
