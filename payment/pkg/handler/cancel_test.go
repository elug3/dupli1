...
func newCancelFixture(t *testing.T, totalKRW int64) (*http.ServeMux, *domain.Payment) {
	t.Helper()
	repo := memory.NewRepository()
	svc := service.New(repo, cancelOrderClient{totalKRW: totalKRW}, fakeCheckoutProvider{}, nil)
